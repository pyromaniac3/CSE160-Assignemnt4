...
class Vector3 {
    ...
    add(other) {
        ...
        // get the values of (x1,y1) and (x2,y2)
        ...
        var z2 = other.elements[2];

        // vector add = ((x1+x2),(y1+y2))
        this.elements[0] = x1+x2;
        this.elements[1] = y1+y2;
        this.elements[2] = z1+z2;
    ...
    sub(other) {
        ...
        // vector sub = add(vector1, -vector2);
    ...
    div(scalar) {
        ...
        // vector divide = [x/scalar, y/scalar]
    ...
    mul(scalar) {
        ...
        // vector mult = scalar*[x,y]
        this.elements[0] = scalar*this.elements[0]; 
        this.elements[1] = scalar*this.elements[1];
        this.elements[2] = scalar*this.elements[2];
        // Don't delete the return statement.
        return this;
    };
    ...
    static cross(other1, other2) {
        // Insert your code here.
        const [x1, y1, z1] = other1.elements;
        const [x2, y2, z2] = other2.elements;
